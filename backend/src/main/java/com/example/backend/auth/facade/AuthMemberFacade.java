...
public class AuthMemberFacade {
    ...
    // OAuth 임시 회원 생성
    public Member registerOAuthUser(String provider, String providerUserId, String confirmedEmail,
                                    String nickname, Integer birthYear, Gender gender) {
        return memberService.registerOAuthMember(provider, providerUserId, confirmedEmail, nickname, birthYear, gender);
    }
